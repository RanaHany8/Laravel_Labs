...
<div class="max-w-4xl mx-auto space-y-8 py-10">
    ...
    <div class="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
        ...
        @if($post->image_path)
            <div class="mb-6">
                <img src="{{ asset('storage/' . $post->image_path) }}" alt="Post Image" class="rounded-2xl w-full object-cover max-h-96 shadow-md">
            </div>
        @endif
    ...
    <div class="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <p class="text-gray-700">
                <span class="font-bold text-gray-900">Created At:</span> 
                {{ $post->user && $post->user->created_at ? $post->user->created_at->format('l jS of F Y') : 'N/A' }}
            </p>
        </div>
    </div>
